...
struct FFramePackage
{
	...
	UPROPERTY()
	ABlasterCharacter* Character = nullptr; // The character this frame package belongs to
};
...
private:
	...
	float MaxRecordTime = 4.f; // Maximum time to record frames for lag compensation
