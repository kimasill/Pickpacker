...
void AShotgun::FireShotgun(const TArray<FVector_NetQuantize>& HitTargets)
{
	...
	if (MuzzleFlashSocket)
	{
		...
		// Maps hit characters to the number of pellets that hit them
		...
		// Calculate damage for total hits
		...
		// Apply damage to characters hit by pellets
